...
export const PublicComponent = () => {
  ...
  return (
    <div className="flex flex-col gap-[20px]">
      ...
      <div className="flex flex-col">
        <h3 className="text-[20px]">Building your BB Post payload</h3>
        <div className="text-customColor18 mt-[4px] whitespace-pre-line">
          ...
          We have created an easy way to build your BB Post payload to schedule
          posts. {'\n'}
          You can use the BB Post wizard, and schedule a post with our UI, after
